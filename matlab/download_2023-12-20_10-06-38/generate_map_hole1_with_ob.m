...
%%
ob1_fix = readmatrix("ob1_1-novatel-fix.csv");
ob2_fix = readmatrix("ob2-novatel-fix.csv");
ob3_fix = readmatrix("ob3-novatel-fix.csv");
ob4_fix = readmatrix("ob4-novatel-fix.csv");
ob5_fix = readmatrix("ob5-novatel-fix.csv");
ob6_fix = readmatrix("ob6-novatel-fix.csv");
ob7_fix = readmatrix("ob7-novatel-fix.csv");
ob8_fix = readmatrix("ob8-novatel-fix.csv");
ob9_fix = readmatrix("ob9-novatel-fix.csv");
ob10_fix = readmatrix("ob10-novatel-fix.csv");
ob11_fix = readmatrix("ob11-novatel-fix.csv");
ob12_fix = readmatrix("ob12-novatel-fix.csv");
ob13_fix = readmatrix("ob13-novatel-fix.csv");
ob14_fix = readmatrix("ob14-novatel-fix.csv");
...
imshow(image)
%%
imwrite(image,"0926_route1_resolution05_rtk.png");
